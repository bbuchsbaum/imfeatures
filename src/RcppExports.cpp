...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::string >::type impath(impathSEXP);
    Rcpp::traits::input_parameter< int >::type maxdiag(maxdiagSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_imfeatures_edge_entropy_cpp", (DL_FUNC) &_imfeatures_edge_entropy_cpp, 7},
    {NULL, NULL, 0}
};

RcppExport void R_init_imfeatures(DllInfo *dll) {
